    ...
    var d = {}
        ...
        kI0x: function(a) {
            var c = this.i6c
                ...
                , k = this.blockSize
                , b = j / (4 * k)
                , b = a ? u.ceil(b) : u.max((b | 0) - this.Ip7i, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
...
(function(u) {
        ...
        r = r.MD5 = v.extend({
            ls0x: function() {
                this.cM8E = new w.init([1732584193, 4023233417, 2562383102, 271733878])
            },
            qi2x: function(q, n) {
                for (var a = 0; 16 > a; a++) {
                    var c = n + a
...
CryptoJS.lib.Cipher || function(u) {
    var p = CryptoJS
        ...
        createEncryptor: function(e, a) {
            return this.create(this.Ir7k, e, a)
        },
        createDecryptor: function(e, a) {
            return this.create(this.brh7a, e, a)
        },
        init: function(e, a, b) {
...
(function() {
        ...
        var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
            , d = d.AES = p.extend({
            ls0x: function() {
                for (var a = this.K7D, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bbr3x = d + 6) + 1), e = this.brv7o = [], j = 0; j < a; j++)
                    if (j < d)
                        e[j] = c[j];
                    else {
                        var k = e[j - 1];
            ...
            encryptBlock: function(a, b) {
                this.Dv5A(a, b, this.brv7o, t, r, w, v, l)
            },
            decryptBlock: function(a, c) {
                var d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d;
                this.Dv5A(a, c, this.brw7p, b, x, q, n, s);
                d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d
            },
            Dv5A: function(a, b, c, d, e, j, l, f) {
                for (var m = this.bbr3x, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function musicEncrypt(offset) {

    var i6c = {rid: "R_SO_4_417250673",  offset: offset, total: "false", limit: "20", csrf_token: "d35b038f915a8d33f575de2763899edf"}
    var bry7r2 = "010001";
    var bry7r3 = "";
    var bry7r4 = "0CoJUm6Qyw8W8jud";
    var bUS5X = window.asrsea(JSON.stringify(i6c), bry7r2, bry7r3, bry7r4);
